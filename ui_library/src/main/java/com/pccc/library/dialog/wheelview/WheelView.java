...
public class WheelView extends View {
	 ...
	 * @return the current value
	 */
	public int getCurrentItemForFavor() {
		if(currentItem!=0){
			currentItem = 30;
		}
		return currentItem;
	...
	private void initResourcesIfNecessary() {
		TEXT_SIZE=(int)this.getResources().getDimension(R.dimen.main);
		if (itemsPaint == null) {
		...
		setBackgroundResource(R.drawable.shape_wheel_val);
	}
